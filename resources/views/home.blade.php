...
<div class="container" style="">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin: auto; margin-top:10px; ">
...
<div class="card text-dark bg-info mb-3" style="max-width: 18rem;">
  <div class="card-header">Este sistema fue modificado por:</div>
  <div class="card-body">
    <h3 class="card-title">Univ. ALEX EFRAIN ALEJO QUISPE <br> CI:13278424 LP</h3>
    <div class="row">
  <img src="{{asset('img/perfil.png')}}" class="rounded float-end" alt="...">
    </div>
  </div>
</div>
        ...
        <a href="{{url('admin/user/create')}}">
            <div class="widget stats-widget">
                <div class="widget-body clearfix bg-warning">
                    <div class="pull-left">
                        <h3 class="widget-title text-black">Crear usuario</h3>
                    </div>
